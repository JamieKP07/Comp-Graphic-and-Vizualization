...
private:
	...
	// render the textured ground plane
	void RenderGround();
	...
	// render the potion bottle
	void RenderPotionBottle();
	...
	// render the dice tray
	void RenderDiceTray();

	// render the main stone tower body
	void RenderTowerBody();

	// render the cone-shaped tower roof
	void RenderRoof();

	// render the wooden tray at the front of the tower
	void RenderTray();
