	...
	ShaderManager* pShaderManager)
{
	...
	g_pCamera->Position = glm::vec3(8.0f, 5.5f, 11.0f);
	g_pCamera->Front = glm::vec3(-0.7f, -0.45f, -1.0f);
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection)
	{
		if (bOrthographicProjection)
		{
			// Set a clean front-facing camera for orthographic view
			g_pCamera->Position = glm::vec3(0.0f, 3.0f, 10.0f);
			g_pCamera->Front = glm::vec3(0.0f, 0.0f, -1.0f);
			g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);

			projection = glm::ortho(-5.0f, 5.0f, -6.0f, 6.0f, 0.1f, 100.0f);
		}
	}
	else
	{
